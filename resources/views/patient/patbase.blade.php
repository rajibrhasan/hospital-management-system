...
<div class="wrapper d-flex align-items-stretch">
	<nav id="sidebar" class="active">
				<h1><a href= "{{route('pat.index')}}"class="logo">LH</a></h1>
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="{{url ('pat/viewpres/'.Auth::user()->id)}}"><span class="fa fa-sticky-note"></span>Prescriptions</a>
          </li>
          <li>
            <a href="{{url ('pat/viewreport/'.Auth::user()->id)}}"><span class="fa fa-users"></span>Reports</a>
          </li>
          <li>
            <a href="#"><span class="fa fa-cog"></span>Edit Profile</a>
          </li>
          <li>
            <a href="#"><span class="fas fa-id-badge"></span>Change Profile Picture</a>
          </li>
        </ul>
