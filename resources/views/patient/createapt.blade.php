...
<div class="row align-items-center justify-content-center" style="min-height: 400px;">
	<div class="col-lg-6">
		<div class="card" style="border-radius:15px;">
			<h2 class="text-center mt-3 ">Book Appointment</h2>
			<form class="mb-4 px-5 align-items-center" method="POST" action="{{route('apt.store') }}">
			 @csrf
				<div class="form-group row">
					<label for="appointment_id" class="col-sm-3 col-form-label">Appointment ID</label>
					<div class="col-sm-9">
						<select class="js-example-basic-single js-states" style="width: 100%;height: 40px;"data-live-search="true" placeholder="Appointment ID" id="appointment_id">
						@foreach($apts as $apt)
